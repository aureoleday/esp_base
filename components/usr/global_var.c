...
//    {14,  &g_sys.conf.geo.gain,            0x01,    0x03,       0x01,    0,    NULL},
    {9,   &g_sys.conf.per.adc_offset,      0,       200,        30,      0,    NULL},
    {10,  &g_sys.conf.per.dac_offset,      0,       200,        0,       0,    NULL},
    {11,  &g_sys.conf.per.dac_setval,      0,       255,        159,     0,    NULL},
    {12,  &g_sys.conf.gtz.en,              0,	    1,          0,       0,    NULL},
    {13,  &g_sys.conf.gtz.calc_n,          256,     8000000,    4096,    0,    gtz_rst_opt},
    {14,  &g_sys.conf.gtz.n,               256,     8000000,    4096,    0,    gtz_rst_opt},
    {15,  &g_sys.conf.gtz.intv,            0,       5,          0,       0,    gtz_rst_opt},
    {16,  &g_sys.conf.gtz.target_freq,     1,       1000,       470,     0,    gtz_rst_opt},
    {17,  &g_sys.conf.gtz.sample_freq,     4000,    16000,      4096,    0,    gtz_rst_opt},
    {18,  &g_sys.conf.gtz.target_span,     0,	    16,         3,       0,    gtz_rst_opt},
    {19,  &g_sys.conf.gtz.res_cd,          3,	    255,        40,      0,    gtz_rcd_opt},
    ...
    {39,  &g_sys.conf.adc.drop_th,         0,       16,         2,       0,    NULL},
...
{//     id      mapped registers
    ...
    {	10,     &g_sys.stat.adc.peak,                   0},
    {	11,  	&g_sys.stat.gtz.snr_i,                  0},
    {	12,  	&g_sys.stat.gtz.slv_i,                  0},
    {	13,  	&g_sys.stat.gtz.nlv_i,                  0},
    {	14,  	&g_sys.stat.gtz.res_cd,                 0},
    {	15,  	&g_sys.stat.gtz.res_snr_i,              0},
    {	16,  	&g_sys.stat.gtz.res_slv_i,              0},
    {	17,     &g_sys.stat.adc.raw,                    0},
    {	18,     &g_sys.stat.adc.drop_cnt,               0},
    {	19,     &g_sys.stat.adc.peak,                   0},
