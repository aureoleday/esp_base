...
//    {14,  &g_sys.conf.geo.gain,            0x01,    0x03,       0x01,    0,    NULL},
    ...
    {14,  &g_sys.conf.gtz.n,               8,       20,         12,      0,    gtz_rst_opt},
    {15,  &g_sys.conf.gtz.intv,            0,       10,         0,       0,    gtz_rst_opt},
    {16,  &g_sys.conf.gtz.target_freq,     1,       1000,       470,     0,    gtz_rst_opt},
    {17,  &g_sys.conf.gtz.sample_freq,     4000,    4000,       4096,    0,    gtz_rst_opt},
    {18,  &g_sys.conf.gtz.target_span,     0,	    16,         5,       0,    gtz_rst_opt},
    ...
    {34,  &g_sys.conf.adc.sps,             0,       7,          3,       0,    adc_sps_opt},
